...
class CriarProfessor extends Component {
    constructor(props) {
        super(props);
        ...
        if (redirect) {
            ...
            return (
                <form onSubmit={this.handleSubmit}>
                    <fieldset>
                        <legend>Criar Professor</legend>
                        <div className="professor-insert">
                        ...
                        <div className="professor-insert">
                            <label>
                                <input
                                    ...
                                    name="ativo"
                                    value="true"
                                    checked={this.state.professor.ativo === "true"}
                                    onChange={this.handleInputChange}
                                />
                                Ativo
                        </label>
                            <label>
                                <input
                                    ...
                                    value="false"
                                    name="ativo"
                                    checked={this.state.professor.ativo === "false"}
                                    onChange={this.handleInputChange}
                                />
                                Inativo
                        </label>
